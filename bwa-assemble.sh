...
bwa mem -t 6 $ref /data2/rosyfinches/fastqs/"$ID"_trimmed_1P.fq.gz /data2/rosyfinches/fastqs/"$ID"_trimmed_2P.fq.gz | samtools view -b -o /data2/rosyfinches/bam_files/$ID.bam -S
